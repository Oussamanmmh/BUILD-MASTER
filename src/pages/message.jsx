...
export default function Message() {
    return(
        ...
        <>
            <div className="relative   flex flex-col gap-20 px-20 py-10 mt-10 " style={{backgroundImage:`url(${background})`,backgroundPosition:'center',backgroundSize:'cover',backgroundAttachment:'fixed'}}>
