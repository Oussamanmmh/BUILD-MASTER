import house from '../../assets/2.png'
export default function Page2(){
    return(
        <div className=' relative space-y-20 px-4 md:px-20 py-6 pb-10 rounded-2xl' style={{backgroundImage:`url(${house})`,backgroundSize:'cover',backgroundPosition:'center',backgroundAttachment:"scroll"} }>
